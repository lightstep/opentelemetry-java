...
public final class HttpServerHttp {
  // It's important to initialize your OpenTelemetry SDK as early in your application's lifecycle as
  // possible.
  private static final OpenTelemetry openTelemetry = ExampleConfigurationHttp.initOpenTelemetry();
  ...
  private HttpServerHttp() throws IOException {
    this(port);
  }

  private HttpServerHttp(int port) throws IOException {
    ...
    public void handle(HttpExchange exchange) throws IOException {
      ...
      try (Scope scope = span.makeCurrent()) {
        ...
        */
        ...
        span.setAttribute("http.host", "localhost:" + HttpServerHttp.port);
  ...
  public static void main(String[] args) throws Exception {
    final HttpServerHttp s = new HttpServerHttp();
